...
{
    COMM_CMD_START_MONITORING *pCmd = InputBuffer;
    ...
    MyFltUpdateOptions(gDrv.Options | pCmd->StartMonitorMask);
...
{
    COMM_CMD_STOP_MONITORING *pCmd = InputBuffer;
    ...
    MyFltUpdateOptions(gDrv.Options & (~pCmd->StopMonitorMask));
